...
export async function POST(req: Request) {
  try {
    ...
    const openingInstruction = safeContactPerson
      ? `Nutze den Ansprechpartner "${safeContactPerson}" natürlich und professionell.`
      : `Wenn kein Ansprechpartner vorhanden ist, beginne mit "Sehr geehrte Damen und Herren,". Nach der Anrede folgt immer eine Leerzeile.`;
